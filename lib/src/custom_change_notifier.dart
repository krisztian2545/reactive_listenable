...
const _itemStoreFlutterLibrary =
...
mixin class ChangeNotifierCopy implements Listenable {
  int _count = 0;
  ...
  static bool debugAssertNotDisposed(ChangeNotifierCopy notifier) {
    assert(() {
  ...
  @protected
  static void maybeDispatchObjectCreation(ChangeNotifierCopy object) {
    ...
    if (kFlutterMemoryAllocationsEnabled && !object._creationDispatched) {
      FlutterMemoryAllocations.instance.dispatchObjectCreated(
        library: _itemStoreFlutterLibrary,
        className: '$ChangeNotifierCopy',
        object: object,
      );
  ...
  void addListener(VoidCallback listener) {
    assert(ChangeNotifierCopy.debugAssertNotDisposed(this));
      ...
      try {
        ...
        FlutterError.reportError(FlutterErrorDetails(
          ...
          informationCollector: () => <DiagnosticsNode>[
            DiagnosticsProperty<ChangeNotifierCopy>(
